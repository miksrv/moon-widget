  ...
  (0, import_react.useEffect)(() => {
    ...
    img.onload = () => {
      ...
      if (phase < 0.5) {
        ...
        const shadowFraction = (phase - 0.5) * 2;
...
var MoonWidget = ({ LAT, LON, date, config }) => {
  const selectedDate = new Date(date || (/* @__PURE__ */ new Date()).toISOString().split("T")[0]);
  ...
  const [moonPhase, setMoonPhase] = (0, import_react2.useState)(illumination);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { border: "1px solid #ccc", padding: "10px", width: "250px" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { children: "Moon Widget" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(MoonPhaseView_default, { phase: moonPhase, shadowIntensity: 1.4, shadowSpread: 0.1 }),
    moonPhase,
    ...
    config?.showCoordinates && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { children: [
        "Latitude: ",
        LAT
      ] }),
...
MoonWidget.propTypes = {
  LAT: import_prop_types.default.number.isRequired,
  LON: import_prop_types.default.number.isRequired,
  date: import_prop_types.default.string,
  config: import_prop_types.default.shape({
    showPhase: import_prop_types.default.bool,
    showCoordinates: import_prop_types.default.bool
  })
};
...
root.render(
  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_react3.default.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(MoonWidget_default, { LAT: 51, LON: 56 }) })
);
