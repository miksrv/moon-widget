...
var MoonWidget = ({ LAT, LON, date, config }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { border: "1px solid #ccc", padding: "10px", width: "250px" }, children: [
    /* @__PURE__ */ jsx2("h3", { children: "Moon Widget" }),
    /* @__PURE__ */ jsx2(MoonPhaseView_default, { phase: moonPhase, shadowIntensity: 1.4, shadowSpread: 0.1 }),
    moonPhase,
    ...
    config?.showCoordinates && /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsxs("p", { children: [
        "Latitude: ",
        LAT
      ] }),
...
root.render(
  /* @__PURE__ */ jsx3(React3.StrictMode, { children: /* @__PURE__ */ jsx3(MoonWidget_default, { LAT: 51, LON: 56 }) })
);
